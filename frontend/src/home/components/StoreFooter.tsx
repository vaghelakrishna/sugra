...
export default function StoreFooter() {
  ...
  return <footer className="relative bg-[#111] px-6 pb-7 pt-14 text-[#aeb3c1] sm:px-[3.6vw] sm:pt-20">
    <div className="mx-auto max-w-[1800px]">
      <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_1.05fr_1.15fr_1.35fr] lg:gap-10">
        ...
        <FooterColumn title="Quick Links"><Link to="/collections">All Jewellery</Link><Link to="/collections?category=mystery-scoop">Mystery Scoop</Link><Link to="/collections?category=mystery-jar">Mystery Jar</Link><Link to="/collections?category=rings">Rings</Link><Link to="/collections?category=earrings">Earrings</Link><Link to="/collections?category=necklaces">Necklaces</Link><Link to="/collections?category=bracelets">Bracelets</Link><Link to="/collections?category=watches">Watches</Link></FooterColumn>
